...
def describe_detail():
    def describe_GET():
        ...
        def it_includes_metadata(expect, client, slash):
            ...
            expect(response.json) == {
                ...
                "overlays": 1,
                "styles": ["default"],
                "blank": "https://meme.bigosoft.us/images/iw.png",
                "example": {
                ...
                "keywords": [],
                "_self": "https://meme.bigosoft.us/templates/iw",
            }
        ...
        def it_defaults_to_animated_example_when_available(expect, client):
            ...
            expect(response.json["example"]["url"]) == (
                "https://meme.bigosoft.us/images/bongo/"
    ...
    def describe_POST():
        ...
        def it_returns_an_image_url(expect, client, as_json):
            ...
            expect(response.json) == {
                "url": "https://meme.bigosoft.us/images/iw/foo/bar.jpg"
            }
        ...
        def it_supports_custom_backgrounds(expect, client, as_json):
            ...
            expect(response.status) == 201
            expect(response.json) == {
                "url": "https://meme.bigosoft.us/images/custom/foo/bar.jpg"
                "?background=https://www.gstatic.com/webp/gallery/3.png"
            }
        ...
        def it_accepts_template_id_as_custom_background(expect, client):
            ...
            expect(response.status) == 201
            expect(response.json) == {
                "url": "https://meme.bigosoft.us/images/fry/foo/bar.jpg"
            }
        ...
        def it_redirects_if_requested(expect, client, id):
            ...
            redirect = f"https://meme.bigosoft.us/images/{id}/abc.png?status=201"
